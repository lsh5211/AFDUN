...
from AFDUN import Net
from utils import *
from skimage.metrics import structural_similarity as ssim
from time import time
from tqdm import tqdm

parser = ArgumentParser(description='AFDUN')
parser.add_argument('--start_epoch', type=int, default=0)
parser.add_argument('--end_epoch', type=int, default=500)
parser.add_argument('--phase_num', type=int, default=8)
...
model_dir = './%s/model_%d_ratio_%.2f_layer_%d_block_%d' % (args.model_dir, channel_number, cs_ratio, N_p, B)
log_path = './%s/model_%d_ratio_%.2f_layer_%d_block_%d.txt' % (args.log_dir, channel_number, cs_ratio, N_p, B)
